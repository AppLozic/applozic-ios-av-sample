...
#ifndef APPLOZIC_SWIFT_H
#define APPLOZIC_SWIFT_H
...
SWIFT_CLASS("_TtC8Applozic17ALCustomSearchBar")
@interface ALCustomSearchBar : UIView
...
SWIFT_CLASS("_TtC8Applozic18ALLoadingIndicator")
@interface ALLoadingIndicator : UIStackView
...
- (void)startLoadingWithLoadText:(NSString * _Nonnull)loadText;
- (void)stopLoading;
...
@interface ALPreviewPhotoViewController : UIViewController
- (nonnull instancetype)initWithImage:(UIImage * _Nonnull)image pathExtension:(NSString * _Nonnull)pathExtension OBJC_DESIGNATED_INITIALIZER;
...
@interface ALPreviewPhotoViewController (SWIFT_EXTENSION(Applozic)) <UIScrollViewDelegate>
...
SWIFT_CLASS("_TtC8Applozic17ALSearchViewModel")
@interface ALSearchViewModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (NSInteger)numberOfSections SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)numberOfRowsInSection SWIFT_WARN_UNUSED_RESULT;
- (void)clear;
- (ALMessage * _Nullable)messageAtIndexPathWithIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)searchMessageWith:(NSString * _Nonnull)key :(void (^ _Nonnull)(BOOL))completion;
@end
...
SWIFT_CLASS("_TtC8Applozic17PasswordQueryable")
@interface PasswordQueryable : NSObject
...
SWIFT_PROTOCOL("_TtP8Applozic20SecureStoreQueryable_")
@protocol SecureStoreQueryable
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull query;
@end


@interface PasswordQueryable (SWIFT_EXTENSION(Applozic)) <SecureStoreQueryable>
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull query;
@end


SWIFT_CLASS("_TtC8Applozic11SecureStore")
@interface SecureStore : NSObject
- (nonnull instancetype)initWithSecureStoreQueryable:(id <SecureStoreQueryable> _Nonnull)secureStoreQueryable OBJC_DESIGNATED_INITIALIZER;
- (BOOL)setValue:(NSString * _Nonnull)value for:(NSString * _Nonnull)userAccount error:(NSError * _Nullable * _Nullable)error;
- (NSString * _Nullable)getValueFor:(NSString * _Nonnull)userAccount error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
+ (ALJWT * _Nullable)decodeWithJwt:(NSString * _Nonnull)jwtValue error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
